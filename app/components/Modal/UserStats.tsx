...
export const UserStats = React.memo((stats:any) => {
    ...
    return (
        <>
        <div>
            <h2 className='font-serif text-2xl text-center'>User Stats</h2>
            <li>Overall Games Played: {gamesPlayed}</li>
            <li>% Games Won: {gamesWonPercentage}%</li>
            <li>Average Guess Count: {avgGuessCount}</li>
        </div>
        </>
    )
})